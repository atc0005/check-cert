...
// Branding returns application name and version information. This function is
// intended to be called as a final step before application exit just after
// the service check output is emitted.
func Branding() string {
	return "Notification generated by " + Version()
}
