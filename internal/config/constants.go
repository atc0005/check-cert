...
const (
	...
	omitSANsEntriesFlagHelp                                  string = "Alias for \"" + OmitSANsListFlagLong + "\" flag"
...
const (
	...
	OmitSANsListFlagLong     string = "omit-sans-list"
	OmitSANsEntriesFlagLong  string = "omit-sans-entries"
